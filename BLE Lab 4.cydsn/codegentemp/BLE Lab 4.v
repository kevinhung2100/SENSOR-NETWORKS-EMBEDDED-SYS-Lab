...
`else
`define CY_BLK_DIR "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\PrISM_v2_20"
`include "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\PrISM_v2_20\PrISM_v2_20.v"
`endif
...
`else
`define CY_BLK_DIR "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`else
`define CY_BLK_DIR "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\OneTerminal"
`include "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\OneTerminal\OneTerminal.v"
`endif
...
`else
`define CY_BLK_DIR "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "D:\program\CY8\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
module CapSense_CSD_P4_v2_20_3 ;
	...
	cy_clock_v1_0
		#(.id("1c1ab2fa-c25a-418a-9d20-537faed7afc6/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c1ab2fa-c25a-418a-9d20-537faed7afc6/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c1ab2fa-c25a-418a-9d20-537faed7afc6/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("1c1ab2fa-c25a-418a-9d20-537faed7afc6/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a0123dce-7175-499d-92f2-7bda16203f89"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4eaf0b61-6148-4991-9cdc-51bcf9629bb3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_4031 = 1'h1;

    assign Net_4033 = 1'h0;

    assign Net_4032 = 1'h0;
