...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* CapSence Service service */
    {
        0x000Cu, /* Handle of the CapSence Service service */ 
        {

            /* CapSence Characteristic characteristic */
            {
                0x000Eu, /* Handle of the CapSence Characteristic characteristic */ 
    ...
    /* RGB LED Characteristic service */
    {
        0x0012u, /* Handle of the RGB LED Characteristic service */ 
        {

            /* Custom Characteristic characteristic */
            {
                0x0014u, /* Handle of the Custom Characteristic characteristic */ 
