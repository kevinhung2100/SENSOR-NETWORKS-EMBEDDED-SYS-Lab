...
#define CYBLE_CAPSENCE_SERVICE_SERVICE_INDEX   (0x00u) /* Index of CapSence Service service in the cyBle_customs array */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of CapSence Characteristic characteristic */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x02u) /* Index of Custom Descriptor descriptor */

#define CYBLE_RGB_LED_CHARACTERISTIC_SERVICE_INDEX   (0x01u) /* Index of RGB LED Characteristic service in the cyBle_customs array */
#define CYBLE_RGB_LED_CHARACTERISTIC_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_RGB_LED_CHARACTERISTIC_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_CAPSENCE_SERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSence Service service */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CHAR_HANDLE   (0x000Eu) /* Handle of CapSence Characteristic characteristic */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_CAPSENCE_SERVICE_CAPSENCE_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0011u) /* Handle of Custom Descriptor descriptor */

#define CYBLE_RGB_LED_CHARACTERISTIC_SERVICE_HANDLE   (0x0012u) /* Handle of RGB LED Characteristic service */
#define CYBLE_RGB_LED_CHARACTERISTIC_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0014u) /* Handle of Custom Characteristic characteristic */
#define CYBLE_RGB_LED_CHARACTERISTIC_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0015u) /* Handle of Characteristic User Description descriptor */
